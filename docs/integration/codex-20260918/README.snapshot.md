...
AutoCAD readiness also requires `acad2022.cfg` beside the configured Core Console executable. This prevents the API from accepting jobs when Core Console is installed but cannot initialize its configuration.
